...
const ecuadorCasinos = [
  ...
  { rank: 3, name: "1xBet", slug: "1xbet", bonus: "Paquete hasta $2,275 + 150 giros", rating: 9.3, bjTables: "25+", liveBj: true, highlight: false },
  ...
  { rank: 9, name: "Melbet", slug: "melbet", bonus: "100% + 30 giros", rating: 8.3, bjTables: "10+", liveBj: true, highlight: false },
];

const faqItems = [
  { q: "¿Cuál es el mejor casino para blackjack online en Ecuador?", a: "Para nosotros, Betsson gana en Ecuador: pasa de 30 mesas de blackjack en vivo — con las variantes de Evolution incluidas (Infinite, Speed, Lightning) —, crupieres que hablan español y un bono que duplica tu primer depósito. Si lo que buscas es la mayor variedad de mesas, FRESH Casino tiene 45+ pero sin licencia ecuatoriana. Para apuestas deportivas y casino combinados, 1xBet también es buena opción." },
    ...
    <>
      ...
      <Section id="analisis">
        ...
        <div className="mb-12">
          ...
          <p className="text-[#9ca3af] leading-relaxed mb-3">
            Puesto #3 para 1xBet, y en blackjack lo respalda: más de 25 mesas en vivo entre Evolution y Ezugi, con Infinite Blackjack desde $1-2 por mano, Speed para sesiones rápidas y mesas VIP. Todo en dólares y con dealers en español en la mayoría de las mesas.
          </p>
          <p className="text-[#9ca3af] leading-relaxed mb-4">
            El paquete de bienvenida suma hasta $2,275 + 150 giros en los primeros 4 depósitos, y con USDT los retiros llegan en minutos. Consejo honesto: el blackjack aporta poco al rollover del bono, así que si vienes solo por el 21, evalúa jugar sin bono.
          </p>
