...
const categoryPicks = [
  ...
  { title: "Mejor para slots", casino: "STARDA Casino", slug: "starda-casino", reason: "Si lo tuyo son las tragamonedas, STARDA es tu casa en Ecuador: torneos cada semana con bolsas de $15,000 USD, slots exclusivos y el catálogo de juegos crash más chévere que probamos." },
...
const faqItems = [
  ...
  { q: "¿Puedo jugar desde el celular?", a: "Claro que sí — es más, en Ecuador la mayoría juega así. Ningún casino del ranking exige descarga: abres Chrome o Safari y funciona de una. Bet365 tiene app nativa si la prefieres. Lo probamos con un gama media y datos de Claro: cero problemas." },
...
const glossary = [
  ...
  { term: "House Edge", def: "El margen matemático de la casa en cada juego. Referencias rápidas: blackjack con estrategia básica 0.5%, ruleta europea 2.7%, ruleta americana 5.26% — por eso la americana se evita siempre." },
    ...
    <>
      ...
      <Section id="analisis" alt bg="/img/backgrounds/paises.png">
        ...
        <div className="rounded-2xl bg-[#141414] border border-white/[0.06] p-6 sm:p-8">
          ...
          Bet365 no necesita presentación: es la casa de apuestas más grande del planeta, y esa escala se nota en lo que más importa — la confiabilidad. En años de operación global es prácticamente imposible encontrar un caso serio de impago. Su casino online en Ecuador cumple sin alardes: menos bonos que otros, sí, pero una tranquilidad que pocos igualan.
        </p>
      ...
      <Section id="bonos" bg="/img/backgrounds/slots.png">
        ...
        <div className="space-y-10">
          ...
          <div>
            ...
            <p className="text-[#9ca3af] leading-relaxed mb-2">
          Giros gratis para tragamonedas, con una trampa de valor que conviene dominar: 50 giros de $0.10 suman $5, mientras que 20 giros de $0.50 valen $10. El número grande de giros no siempre es el premio grande — multiplica cantidad por valor antes de emocionarte. FRESH suele incluirlos en su bienvenida con condiciones razonables.
        </p>
          ...
          <div>
            ...
            <p className="text-[#9ca3af] leading-relaxed mb-2">
          El bono de recarga es la versión “cliente frecuente” del de bienvenida: premia tus depósitos siguientes, no solo el primero. FRESH, por ejemplo, da 50% extra los viernes. Si juegas con regularidad desde Ecuador, estos bonos van sumando un colchón nada despreciable mes a mes — revisa la sección de promociones antes de cada depósito.
        </p>
          ...
          <div>
            ...
            <p className="text-[#9ca3af] leading-relaxed mb-2">
          Los programas VIP funcionan por niveles que suben con tu actividad. En FRESH son 7 escalones, y los de arriba desbloquean retiros más rápidos, bonos a medida y hasta gerente de cuenta personal. ¿Vale la pena perseguirlos? Solo si ya ibas a jugar de todas formas — subir de nivel jamás debe ser la razón para apostar más.
        </p>
      ...
      <Section id="responsable" alt bg="/img/backgrounds/cripto.png">
        ...
        <p className="text-[#9ca3af] leading-relaxed mb-3">
          Sobre la Martingala (doblar la apuesta tras cada pérdida) y la Fibonacci, la verdad ecuatoriana y universal: fallan. Ambas chocan tarde o temprano contra el mismo muro doble — los límites de mesa y el tamaño finito de tu billetera. Una mala racha de 8 rojos seguidos (pasa más seguido de lo que crees) exige apuestas gigantes para recuperar $1. Diviértete con los sistemas si quieres, pero jamás les confíes plata que te duela.
        </p>
      ...
      <Section id="como-elegir" bg="/img/backgrounds/blackjack.png">
        ...
        <div className="space-y-8">
          {[
            ...
            {step:"4",title:"Prueba la plataforma",desc:"Recorre el casino antes de poner un dólar: velocidad de carga, si los juegos aparecen fácil, si el demo está disponible para practicar gratis. En Ecuador, la mayoría juega desde el celular con datos de Claro, Movistar o CNT. Si la plataforma tarda más de 5 segundos en cargar un juego con datos móviles, va a ser una experiencia frustrante. Probamos todos los casinos del ranking desde un Xiaomi Redmi con datos de Claro y los que mejor funcionaron fueron FRESH, SOL y Bet365.",tip:"Pruébalo desde el celular con datos móviles, no solo con WiFi. Esa es la experiencia real que vas a tener la mayor parte del tiempo."},
      ...
      <section className="bg-gradient-to-b from-[#0a0a0a] to-[#0e0e0e] py-16 sm:py-24 text-center border-t border-white/[0.04]">
        <div className="mx-auto max-w-3xl px-4 sm:px-6">
          ...
          Ya tienes el mapa completo: elige el casino que va contigo, activa el bono con las condiciones claras y juega tranquilo. Cada nombre de este ranking pasó nuestras pruebas con depósitos y retiros reales desde Ecuador — eso es exactamente lo que significa “verificado” en esta página.
        </p>
