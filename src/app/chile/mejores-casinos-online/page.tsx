    ...
    <>
      ...
      <Section id="analisis" alt bg="/img/backgrounds/paises.png">
        ...
        <div className="mb-16">
          ...
          <h4 className="text-lg font-bold text-white mb-3">+10.000 juegos — el catálogo más grande del ranking</h4>
          <p className="text-[#9ca3af] leading-relaxed mb-3">
          ...
          <p className="text-[#9ca3af] leading-relaxed mb-3">
            La interfaz, considerando la cantidad de juegos, está bien organizada. Filtros por proveedor,
            tipo, volatilidad, características. El buscador funciona al toque. Si cachai de slots, vas a
            tener juegos nuevos para probar por meses.
          </p>

          <h4 className="text-lg font-bold text-white mb-3">Bono de bienvenida: $5.000.000 CLP + 250 giros gratis</h4>
          <p className="text-[#9ca3af] leading-relaxed mb-3">
            ...
            juegas con $110.000. El rollover es x50 y tienes solo 72 horas (3 días) desde que se acredita para cumplirlo. No te voy a mentir, es cuática esa condición:
          ...
          <p className="text-[#9ca3af] leading-relaxed mb-3">
            PIN-UP no es solo casino. Tienen <strong className="text-white">apuestas deportivas</strong> con
            mercados para todo: fútbol (Primera División, Premier, La Liga), NBA, tenis, hasta eSports. El
            casino en vivo tiene mesas de Evolution, Pragmatic Live y Ezugi — blackjack, ruleta, baccarat,
      ...
      <Section id="mitos">
        ...
        <div className="space-y-5">
          {[
            ...
            {claim:"Los bonos siempre convienen",verdict:"DEPENDE",color:"#f59e0b",explanation:"Un bono con rollover x25 y 30 días puede ser bacán. Uno con rollover x50 y 3 días puede ser peor que no aceptar nada. Hagamos las cuentas en CLP: si aceptas un bono de $50.000 CLP con rollover x50, necesitas apostar $2.500.000 CLP en 3 días. Son más de $833.000 CLP diarios en apuestas. A $500 por giro, son más de 1.600 giros diarios. Si no juegas tanto, vas a perder el bono y probablemente tu depósito también tratando de cumplir el rollover. En Chile, donde muchos jugadores depositan montos altos, el rollover se amplifica. Lee SIEMPRE las condiciones antes de aceptar. A veces rechazar el bono y jugar solo con tu plata es la decisión más inteligente."},
      ...
      <Section id="responsable" alt bg="/img/backgrounds/cripto.png">
        ...
        <p className="text-[#9ca3af] leading-relaxed mb-3">
          ¿La Martingala? ¿La Fibonacci? Mira, te lo decimos al tiro: no funcionan, y no es opinión. Doblar la apuesta después de cada pérdida suena lógico hasta que aparece la racha de 8 rojos seguidos y el sistema te pide apostar una fortuna para recuperar luca. Ahí te frenan dos muros: el límite de la mesa y tu propio bolsillo. Juega con sistemas si te divierten, pero como entretención — jamás como plan.
        </p>
