              ...
              <div key={casino.slug} className="relative">
                ...
                >
                  <div className={`relative p-6 flex flex-col flex-1 ${
                    ...
                    {/* Casino name */}
                    <h3 className={`text-2xl font-black mb-3 transition-colors duration-200 ${
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {comparisons.map((comp) => (
              ...
              >
                ...
                <div className="relative bg-[#141414] flex flex-col flex-1">
                  ...
                  <div className="relative p-8">
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
                      <div className="w-14 h-14 rounded-full bg-gradient-to-br from-primary to-primary-dark flex items-center justify-center shadow-[0_0_25px_rgba(239,68,68,0.4)] group-hover:shadow-[0_0_40px_rgba(239,68,68,0.6)] transition-shadow duration-300">
                    ...
                    <div className="flex items-center justify-between gap-8">
                      ...
                      <div className="flex-1 text-center">
                        <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary/20 to-primary/5 border border-primary/25 flex items-center justify-center mx-auto mb-4 group-hover:border-primary/40 group-hover:shadow-[0_0_15px_rgba(239,68,68,0.15)] transition-all duration-300">
                      ...
                      {/* Casino B */}
                      <div className="flex-1 text-center">
                        <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-accent/20 to-accent/5 border border-accent/25 flex items-center justify-center mx-auto mb-4 group-hover:border-accent/40 group-hover:shadow-[0_0_15px_rgba(245,158,11,0.15)] transition-all duration-300">
                  ...
                  {/* Bottom bar */}
                  <div className="mt-auto px-8 py-4 bg-white/[0.02] border-t border-white/5 flex items-center justify-center gap-2 text-sm font-bold text-primary group-hover:text-[#ff6b6b] transition-colors duration-200">
                ...
                {/* Hover glow */}
                <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
                  style={{ boxShadow: "0 0 40px rgba(239,68,68,0.08), 0 0 80px rgba(245,158,11,0.05)" }}
                />
              </Link>
            ))}
          </div>
